...
import { result } from '../../../../../src/mocks/population/composition/per-year/get/constants'
import { Error } from '../../../../../src/mocks/types'
import { Error as ErrorResponse } from '../../../error'

import { perYear as handler } from '.'
...
const params = { ['pref-code']: '11', ['city-code']: '11362' }

describe('/api/population/composition/per-year', () => {
  ...
  test(`${StatusCodes.BAD_REQUEST} for Invalid Params`, async () => {
    const mockReq = httpMocks.createRequest<NextApiRequest>({
      query: { ['pref-code']: 'invalid', ['city-code']: 'invalid' },
    })
    const mockRes = httpMocks.createResponse<NextApiResponse>({})
